...
#define GLASS_MODELVIEW_STACK_SIZE 16
#define GLASS_PROJECTION_STACK_SIZE 2
#define GLASS_TEXTURE_STACK_SIZE 2
...
#define GLASS_CONTEXT_FLAG_MATRIX DECL_FLAG(17)
